...
impl<State: VerificationState> SignedMantleTx<State> {
    ...
    pub fn ops_proofs(&self) -> &Vec<OpProof> {
        &self.ops_proofs
    }
}

impl SignedMantleTx<Unverified> {
    pub fn new(mantle_tx: MantleTx, ops_proofs: Vec<OpProof>) -> Self {
        Self {
            mantle_tx,
            ops_proofs,
            state: Unverified,
...
mod tests {
    ...
    fn create_withdraw_tx(
        ...
        SignedMantleTx::new(mantle_tx, vec![OpProof::ChannelMultiSigProof(proof)])
    }
